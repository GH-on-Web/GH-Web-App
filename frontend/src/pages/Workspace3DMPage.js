...
import { Box, Typography, Button, Toolbar, useMediaQuery, IconButton } from '@mui/material';
      ...
      <AppLayout
        ...
        main={
          <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            ...
            <LiveCursorsContainer enabled={true} style={{ flexGrow: 1, position: 'relative', overflow: 'hidden', minHeight: 0 }}>
              <FlowCanvas
                nodes={nodes}
                edges={edges}
                nodeTypes={nodeTypes}
